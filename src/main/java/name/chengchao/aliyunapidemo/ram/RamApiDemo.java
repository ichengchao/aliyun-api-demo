package name.chengchao.aliyunapidemo.ram;
...
/**
 * 修改RD中所有子账号的role最大过期时间的demo
 */
public class RamApiDemo {


    // 这个需要是RD主账号中的ram user的AK,需要有AdministratorAccess的权限
    public static final String Aliyun_AccessKeyId = "<your-access-key-id>";
    public static final String Aliyun_AccessKeySecret = "<your-access-key-secret>";
